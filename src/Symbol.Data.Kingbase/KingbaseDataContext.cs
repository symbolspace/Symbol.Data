...
namespace Symbol.Data.Kingbase {
    ...
    /// Kingbase 数据上下文。
    /// </summary>
    public class KingbaseDataContext : AdoDataContext {
        ...
        public KingbaseDataContext(IConnection connection) 
            : base(connection) {
        }
        #endregion
        ...
        protected override ICommand CreateCommand() {
            return new KingbaseCommand(this);
        }
...
ORDER BY
    col.table_name,col.ordinal_position;
        ...
        public override ISelectCommandBuilder CreateSelect(string tableName) {
            return new KingbaseSelectCommandBuilder(this, tableName, null);
        }
        /// <summary>
        /// 创建查询命令构造器。
        /// </summary>
        ...
        public override ISelectCommandBuilder CreateSelect(string tableName, string commandText) {
            return new KingbaseSelectCommandBuilder(this, tableName, commandText);
        }
        #endregion
        #region CreateInsert
        /// <summary>
        ...
        public override IInsertCommandBuilder CreateInsert(string tableName) {
            return new KingbaseInsertCommandBuilder(this, tableName);
        }
        #endregion
        #region CreateUpdate
        /// <summary>
        ...
        public override IUpdateCommandBuilder CreateUpdate(string tableName) {
            return new KingbaseUpdateCommandBuilder(this, tableName);
        }
        #endregion
