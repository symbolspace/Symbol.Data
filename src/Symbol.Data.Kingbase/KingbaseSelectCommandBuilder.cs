...
namespace Symbol.Data.Kingbase {
    ...
    /// Kingbase 查询命令构造器基类
    /// </summary>
    public class KingbaseSelectCommandBuilder : Symbol.Data.SelectCommandBuilder {
        ...
        public KingbaseSelectCommandBuilder(IDataContext dataContext, string tableName, string commandText)
