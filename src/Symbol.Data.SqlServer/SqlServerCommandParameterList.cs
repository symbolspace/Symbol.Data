...
namespace Symbol.Data {
    ...
    /// SqlServer 命令参数列表
    /// </summary>
    public class SqlServerCommandParameterList : CommandParameterList {
        ...
        #region ctor
        /// <summary>
        /// 创建SqlServerCommandParameterList实例。
        /// </summary>
        /// <param name="provider">提供者。</param>
        public SqlServerCommandParameterList(IProvider provider)
            : base(provider) {
        }
        #endregion
